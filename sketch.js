      ...
      let car = {wheels: 7, horsepower: 120, color: 'blue'};

      let bassGuitar= {strings: 4, color: 'red', frets: 21 };

      console.log (bassGuitar.strings);
      console.log (bassGuitar.color);
      console.log (bassGuitar.frets);
